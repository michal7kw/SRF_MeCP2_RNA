#!/bin/bash
#SBATCH --job-name=06c_prepare_neuron_go_enrichment
#SBATCH --account=kubacki.michal
#SBATCH --mem=32GB
#SBATCH --time=04:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=8
#SBATCH --error="./logs/06c_prepare_neuron_go_enrichment.err"
#SBATCH --output="./logs/06c_prepare_neuron_go_enrichment.out"
...
# Run the R script
Rscript scripts/06c_prepare_neuron_go_enrichment.R
