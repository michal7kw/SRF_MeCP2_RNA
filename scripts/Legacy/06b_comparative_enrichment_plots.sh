#!/bin/bash
#SBATCH --job-name=06b_comparative_enrichment_plots
#SBATCH --account=kubacki.michal
#SBATCH --mem=32GB
#SBATCH --time=04:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=8
#SBATCH --error="./logs/06b_comparative_enrichment_plots.err"
#SBATCH --output="./logs/06b_comparative_enrichment_plots.out"
...
# Run the R script
Rscript scripts/06b_comparative_enrichment_plots.R
